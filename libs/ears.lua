-- config --
local config = {
    leftEar = models.model.root.Torso.Head.LeftEars, -- model part of left ear
    rightEar = models.model.root.Torso.Head.RightEars, -- model part of right ear
    ...
    addAngle = {5}, -- adds angle to ear rotation
}
